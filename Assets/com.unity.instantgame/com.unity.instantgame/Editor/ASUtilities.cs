...
namespace Unity.AutoStreaming
{
    ...
    {
        [MenuItem("IgTool/Reimport Models with DefaultImportMaterial")]
...
#if IG_C109
        [MenuItem("IgTool/Pack Pre-download Bundles")]
        static void PackPredownloadBundles()
        {
        ...
        [MenuItem("IgTool/Generate Pre-download List for Scenes")]
        static void GeneratePredownloadListForScenes()
        {
            UnityEditor.AutoStreamingSettings.GeneratePredownloadForScenes();
        }
#endif
    }
}
